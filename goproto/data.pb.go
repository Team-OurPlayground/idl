...
type Data struct {
	...
	Dy       float32 `protobuf:"fixed32,4,opt,name=dy,proto3" json:"dy,omitempty"`
}
...
func (x *Data) GetFunction() string {
	if x != nil {
		return x.Function
	}
	return ""
...
var file_proto_data_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x56, 0x0a, 0x04, 0x64, 0x61, 0x74,
	0x61, 0x12, 0x1a, 0x0a, 0x08, 0x66, 0x75, 0x6e, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x01, 0x20,
